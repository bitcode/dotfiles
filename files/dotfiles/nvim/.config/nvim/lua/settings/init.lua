...
-- Noice / nvim-notify highlights (match float theme)
vim.api.nvim_set_hl(0, 'NoiceCmdlinePopup', { bg = '#3B4252' })
vim.api.nvim_set_hl(0, 'NoiceCmdlinePopupBorder', { bg = '#3B4252', fg = '#5E81AC' })
vim.api.nvim_set_hl(0, 'NoiceCmdlinePopupTitle', { bg = '#3B4252', fg = '#5E81AC' })
vim.api.nvim_set_hl(0, 'NoiceCmdlineIcon', { fg = '#5E81AC' })
vim.api.nvim_set_hl(0, 'NoicePopupmenu', { bg = '#3B4252' })
vim.api.nvim_set_hl(0, 'NoicePopupmenuBorder', { bg = '#3B4252', fg = '#5E81AC' })
vim.api.nvim_set_hl(0, 'NoicePopupmenuSelected', { bg = '#4C566A' })
